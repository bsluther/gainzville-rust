//! Stub data for prototyping UI components before real data is wired up.

use chrono::{Duration, NaiveDate};
use std::collections::HashMap;

use crate::components::Quantizer;

pub fn stub_heatmap_data(today: NaiveDate) -> HashMap<NaiveDate, usize> {
    let raw: &[(i64, f64)] = &[
        (0, 0.0),
        (1, 45.0),
        (2, 60.0),
...
pub fn heatmap_colors() -> Vec<String> {
    vec![
